...
function reconcileAnswers(answers, changed, domains, previous) {
  ...
  if(changed === 'region' && previous && previous !== answers.region && (locationFrame(previous) !== locationFrame(answers.region))) {
...
function cleanExport(answers, version, domains) {
  ...
  return {schema_version:'1.0',questionnaire_revision:'2026-09-24-ethics-review',questionnaire_version:version,storage:'downloaded_by_respondent; not submitted',answers:copy};
}
...
const PARTICIPANT_NOTICE_VERSION = '2026-09-24-v6';
const PARTICIPANT_INFORMATION = [
  ['Your choice', 'Taking part is voluntary. Most questions are optional. You can skip them or stop at any time. Some ask about wellbeing, disability or safety. Please answer about your own experience and leave out names, service numbers, units and other identifying details.'],
  ['Your answers on this page', 'Your answers stay in this browser page. They are not sent to Lutheran Care. If you choose to download your answers, a copy will be saved on your device.'],
  ['Why these questions are being asked', 'Lutheran Care is seeking to understand what support Defence families need, to help plan its Northern Territory family support program. Choosing a support option does not arrange a service, referral or follow-up interview.'],
  ['If you need help', 'This questionnaire is not a way to request urgent help. In Australia, call 000 in an emergency. For confidential domestic, family or sexual violence support, call 1800RESPECT on 1800 737 732 or visit <a href="https://www.1800respect.org.au/" target="_blank" rel="noopener">1800respect.org.au</a>.'],
  ['Page hosting', 'GitHub Pages hosts this page and records visitors’ IP addresses for security. This is separate from your answers. See the <a href="https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement" target="_blank" rel="noopener">GitHub Privacy Statement</a>.'],
  ['Privacy questions', 'Contact <a href="mailto:feedback@lutherancare.org.au">feedback@lutherancare.org.au</a> about Lutheran Care’s handling of personal information. Its <a href="https://www.lutherancare.org.au/privacy-policy/" target="_blank" rel="noopener">Privacy Policy</a> explains access, correction and complaints.']
];
...
function participationRecord(age, accepted) {
  ...
  return {notice_version:PARTICIPANT_NOTICE_VERSION,age_path:age,kind:'acknowledgement',agreed:true,recorded_at:new Date().toISOString()};
}
...
function renderParticipation(){
  ...
  const explanation=adult
    ? '<p>Most questions are optional. Please answer about yourself and leave out identifying details. Your answers stay in this page unless you download them; they are not sent to Lutheran Care.</p>'
    : '<p>You can skip most questions or stop whenever you want. Your answers stay on this page. They are not sent to Lutheran Care. If you download them, they will be saved on the device you are using.</p><p>Please leave out names, school names and details that could identify anyone. Ask someone you trust to explain anything you do not understand.</p>';
  const statement=adult ? 'I have read the information above and want to continue.' : 'I understand and want to continue.';
