...
function renderWelcome(){
  ...
  main.innerHTML=`<div class="welcome"><section class="welcome-intro"><h1>Have your say on Defence life in the Northern Territory</h1><p class="preview-label">Draft questionnaire · Responses are not collected</p><p class="lead">We’d like to hear what’s working well for you and your family, what could be easier, and what you’d like from local support.</p><p>Your experience can help us understand what the Defence community here needs and what’s worth keeping for other members and families, including those arriving on their next posting.</p><p>You don’t need to be looking for help to take part. Please share your own views; other members of your family are welcome to share theirs.</p><p class="small">For Australian Defence Force members and other countries’ military personnel currently serving in the NT, and their families, including family members living elsewhere.</p></section><section class="welcome-card" aria-label="Choose your age group"><form id="welcome-form"><fieldset class="question-group"><legend>Which age group are you in?</legend><div class="age-grid">${opts([['adult','18 or older','Estimated 8–10 minutes'],['youth','12–17','Estimated 5–7 minutes'],['child','7–11','Estimated 3–5 minutes'],['young','Under 7','Conversation guide']]).map(o=>optionHTML(o,{key:'age',type:'single'},state.age)).join('')}</div></fieldset><p class="small">Taking part is voluntary. Most questions are optional. You can go back to change an answer or stop at any time.</p><div class="error" id="welcome-error" role="alert"></div><button class="button primary" type="submit">Continue</button></form></section></div>`;
