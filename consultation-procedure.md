...
The project lead allocates response review to a trained project worker and names a backup in LC’s internal records. The lead owns access permissions, staff briefing and de-identified reporting to Defence. The assigned worker checks received responses each working day during consultation, with cover during absence and a final check after collection closes. The survey is never advertised as an emergency response channel.

Use LC’s approved record system and existing child-safety/incident processes. Keep the planning dataset separate from any restricted consent-assessment or safeguarding record. Do not put real responses, screenshots, identities, case notes or consent documents in GitHub, Git issues or the personal development folder. Provide only necessary access. Follow LC’s applicable records retention/disposal rules; this procedure does not invent a universal survey retention period.
...
If the young person needs explanation, the adult’s authority is uncertain, no guardian is available, or seeking permission would feel unsafe, use the LC-assisted route. The public form offers a conversation with a worker; it does not provide a checkbox that pretends a worker has approved participation.
...
**Request an interview** invites people to talk with a Lutheran Care staff member so LC can better understand Defence families’ difficulties and support needs. The contact form is independent of the questionnaire and does not receive its answers or response identifiers. It can be used without completing the questionnaire. Its footer and completion links open a separate tab so entering a request does not replace answers in progress. See [CONTACT_FORM.md](CONTACT_FORM.md) for fields and current routes.
...
1. Stop or pause the questions. Listen without investigating, seeking a detailed account or requiring the person to finish.
2. Explain that you may need to share information to keep someone safe or meet legal duties. Do not promise secrecy or promise to inform a parent first where doing so could increase danger.
3. Address immediate danger: in Australia call 000; outside Australia use the relevant local emergency service.
4. Apply the legal reporting duty to the actual information. An individual’s duty must not wait for a supervisor’s permission. Inform the project lead and use LC’s incident process as soon as safely practicable.
5. Explain next steps as far as safe and possible. Offer a suitable support route without promising a particular outcome.

For NT child concerns, the Care and Protection of Children Act 2007 s26 applies where the required reasonable belief of harm, exploitation or specified offending arises. Proof is not required. Contact child protection on 1800 700 250 or police as applicable. A safety-category tick alone does not establish all reporting conditions. If uncertain about reportability, seek advice using the reporting line.

For NT adult domestic violence, s124A of the Domestic and Family Violence Act 2007 concerns the specified reasonable beliefs about serious physical harm, or a serious **or** imminent threat to life or safety. It is not a requirement to report every relationship difficulty. Apply the statutory qualifications and LC’s procedure.

When a response does not identify a person, use the information actually available and seek reporting advice where needed. Do not guess identity from rare response combinations or contact unrelated people. For respondents elsewhere, obtain LC safeguarding advice about the relevant jurisdiction; do not assume NT law is the only applicable law.
