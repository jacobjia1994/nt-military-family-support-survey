...
Jacob’s 25 September feedback on the first published finder was that the page was cluttered and showed too much secondary information. The product rule for this resource is clear hierarchy at a glance: the six choices come first, detailed service conditions remain available when needed, and urgent help stays quick to find without taking over the page.
