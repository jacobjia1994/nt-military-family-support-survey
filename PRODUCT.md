...
On 25 September Jacob approved replacing the generic funding line with: “Lutheran Care received funding from Defence Member and Family Support, a branch of the Commonwealth Department of Defence, to deliver this project.” He also approved one optional positive connection question on the existing connection page. Adults are asked what has helped them or their family feel connected in the NT; young people aged 8–17 are asked what has helped them feel welcome or included in the NT. The question is available on both recent and earlier-experience routes, including when no support need is reported. The separate form for children aged 7 or younger already asks what they like about being here. No interview contact address changes without Lutheran Care confirming it.
...
On 25 September Jacob approved keeping age selection on the invitation page. The team expects more than 95% of respondents to be adults, so **Adult (18 or older)** appears first and **Child or young person (under 18)** appears second. Both unselected rows have equal visual weight and use the questionnaire's standard radio styling. Selecting the latter reveals **8–17** and **7 or younger** as two matching rows below. No age route is preselected. The heading remains **Defence family support survey** in sentence case, without a redundant age-selection hint. The selected route expands its participation explanation and necessary choices on that same page. This is participation information and consent, not a generic legal waiver. The 8–17 choice uses an 8–14/15–17 follow-up solely to show the appropriate permission and agreement steps, while both groups answer one shared questionnaire. Guardian permission plus the young person’s own assent applies to 8–14; 15–17-year-olds give their own informed agreement. A change of route clears incompatible answers and consent. Age seven is a practical supported-response boundary, not a legal or universal reading-capacity threshold.
...
Jacob asked for a standalone resource that lets NT Defence members and families find services in a few clicks. `support.html` is separate from the questionnaire and interview form, requires no response or contact details, and passes no entered information to service links.

On 25 September Jacob accepted a strategy-grounded four-route entrance after rejecting the crowded 11-statement version. The first screen offers **Moving or settling in**, **Apart because of service**, **Leaving Defence or already left**, and **Find help for a specific concern**. A separate human-help link leads directly to staff or service navigation. Moving, separation and leaving routes go from one concrete choice to a contact. The specific-concern route uses five short groups, then two to five distinct needs in a group; safety is directly available on the group screen. A contact is reached in at most three choices. The 39 headings from the earlier research are internal evidence tags, not a public menu or an assertion of NT prevalence. The Defence and Veteran Family Wellbeing Strategy informs life-stage routing; its actions are not proof that a local service is live.

The directory in `support-data.mjs` includes source-checked NT local and national options. `support-journeys.mjs` separates needs that require different first actions, such as school administration and a young person's wellbeing, ordinary healthcare and specialist travel, or debt and employment. A result makes the first contact prominent, shows its audience and area before a call or official-site action, then gives compact alternatives with their own audience and area. Local phone contacts appear in short area-labelled lists where a single national first contact would be misleading. More specialised services remain in a named disclosure. No up-front role or eligibility quiz, topic search, tracking or stored finder choice is used. Language, inclusion, privacy and project feedback remain secondary footer routes. Global urgent contacts are in the footer as Jacob requested, with immediate-danger advice repeated contextually for safety and acute mental distress. Provider availability and eligibility remain the provider’s decision.
