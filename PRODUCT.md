...
On 25 September Jacob accepted a strategy-grounded four-route design after rejecting the crowded 11-statement entrance. The first screen offers **Moving or settling in**, **Apart because of service**, **Leaving Defence or already left**, and **Find help for a specific concern**. A separate human-help link leads directly to staff or service navigation. Each route gives short, concrete next choices; the selected choice opens a curated service answer rather than another taxonomy page. The 39 headings from the earlier research are internal evidence tags, not a public menu or an assertion of NT prevalence. The family-life and service-life stages in the Defence and Veteran Family Wellbeing Strategy informed the routing; strategy actions are not treated as proof that a local service is live.

The directory in `support-data.mjs` includes verified NT local and national options. `support-journeys.mjs` chooses the most useful first contacts for each circumstance and makes regional or specialist alternatives available on the same result page. Results show provider, purpose, area, a decisive limitation and a call or official-site action; full audience and access details open on request. No up-front role or eligibility quiz, topic search, tracking or stored finder choice is used. Language, inclusive and privacy supports and a project-feedback link remain secondary footer routes. Global urgent contacts are in the footer as Jacob requested, with immediate-danger advice repeated contextually where safety or acute mental distress makes it relevant. Provider availability and eligibility remain the provider’s decision.
