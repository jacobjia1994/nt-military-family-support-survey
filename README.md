...
The finder now starts with four circumstance routes. One more choice displays a short, action-ready set of services; a smaller human-help link works for people unsure where to begin. `support-journeys.mjs` holds the reader-facing route-to-service selections. The earlier 39 headings remain internal source tags in `support-data.mjs`, not a public questionnaire, validated taxonomy or measure of NT prevalence. The directory includes NT local and national supports, with provider area and eligibility shown on result cards; named disclosures hold further regional and specialist options. Language, inclusion, privacy, feedback and urgent contacts sit in the footer. There is no topic search or stored finder choice. Official source pages were checked on 25 September 2026; recheck time-sensitive availability before making referrals.
