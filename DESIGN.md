...
Updated after Jacob’s 26 September correction. Mode: Operate. Preserve Lutheran Care identity, self-hosted Karla and restrained colours. Replace mixed task labels and hidden selects with seven consistent support domains and visible questionnaire rows. Print uses #111. This surface has local CSS and does not alter the survey’s visual system.
